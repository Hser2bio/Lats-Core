...
SettingsFaqWidget::SettingsFaqWidget(LATSGUI* parent, ClientModel* _model) :
    QDialog(parent),
        ...
        formatFAQParagraph(
            tr("A masternode is a computer running a full node %1 wallet with a "
               ...
               "regularly. These services include:")
                .arg(PACKAGE_NAME)
                .arg(GUIUtil::formatBalance(clientModel->getMNCollateralRequiredAmount(), BitcoinUnits::LATS)) +
