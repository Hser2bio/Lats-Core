...
const char* BIP71_MIMETYPE_PAYMENT = "application/lats-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/lats-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/lats-paymentrequest";
...
//
// OSX-specific way of handling LATS: URIs and
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in LATS: URIs
...
bool PaymentServer::processPaymentRequest(PaymentRequestPlus& request, SendCoinsRecipient& recipient)
{
    ...
    Q_FOREACH (const PAIRTYPE(CScript, CAmount) & sendingTo, sendingTos) {
        ...
        if (ExtractDestination(sendingTo.first, dest)) {
            ...
            // Insecure payments to custom LATS addresses are not supported
