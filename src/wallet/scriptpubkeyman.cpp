...
void ScriptPubKeyMan::DeriveNewChildKey(CWalletDB &batch, CKeyMetadata& metadata, CKey& secret, const uint8_t& changeType)
{
    ...
    CExtKey cointypeKey;           //key at m/purpose'/coin_type'  --> key at m/44'/LATS_HDCHAIN'
    CExtKey accountKey;            //key at m/purpose'/coin_type'/account' ---> key at m/44'/LATS_HDCHAIN'/account_num'
    CExtKey changeKey;             //key at m/purpose'/coin_type'/account'/change ---> key at m/44'/LATS_HDCHAIN'/account_num'/change', external = 0' or internal = 1'.
    CExtKey childKey;              //key at m/purpose'/coin_type'/account'/change/address_index ---> key at m/44'/LATS_HDCHAIN'/account_num'/change'/<n>'
    ...
    do {
        ...
        // m/44'/LATS_HDCHAIN'/account_num/change'/<n>'
