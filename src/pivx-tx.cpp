...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("LATS lats-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  lats-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded LATS transaction") + "\n" +
                               "  lats-tx [options] -create [commands]   " + _("Create hex-encoded LATS transaction") + "\n" +
                               "\n";
