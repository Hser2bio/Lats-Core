...
class ReorgStakeTest(PivxTestFramework):
    ...
    def run_test(self):
        ...
        # Check LATS supply at the beginning
        # ------------------------------------------
        # LATS supply: block rewards minus burned fees for minting
        ...
        # Verify that LATS supplies were properly updated after the spends and reorgs
