...
Users that wish to prevent this behavior (not recommended) can pass `-backupzmari=0` at the command-line when starting the client, or add `backupzmari=0` to their `lats.conf` file.
