LATS Core version *4.1.0* is now available from:  <https://github.com/lats-dao/lats-core/releases>
...
The minimum required version of QT has been increased from 5.0 to 5.5.1 (the [depends system](https://github.com/lats-dao/lats-core/blob/master/depends/README.md) provides 5.9.7)
