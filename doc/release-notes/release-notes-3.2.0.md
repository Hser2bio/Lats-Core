LATS Core version *3.2.0* is now available from:  <https://github.com/lats-dao/lats-core/releases>
...
A full report provided by LATS developers is available on the [LATS Website](https://lats.org/fake-stake-official-lats-report/), which includes additional findings, mitigation details, and resources for testing. This type of attack has no risk to users' privacy and does not affect their holdings.
...
A full technical writeup of the protocol can be found [Here](https://lats.org/wp-content/uploads/2018/11/Zerocoin_Light_Node_Protocol.pdf).
...
A minor change to these two RPC commands to now display the `mediantime`, used prilatsly during functional tests.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/Latscoin-translations/), the QA team during Testing and the Node hosts supporting our Testnet.
