...
Configuration file:  /etc/pivx/lats.conf
...
`/etc/pivx/lats.conf` with the current systemd, OpenRC, and Upstart init
files out-of-the-box. This is because the command line options specified in the
init files take precedence over the configurations in
`/etc/pivx/lats.conf`. However, some init systems have their own
...
Configuration file:  `~/Library/Application Support/PIVX/lats.conf`
