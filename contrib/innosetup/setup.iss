...
#define MyAppName "Lats Core"
#define MyAppPublisher "2022 DECENOMY Core Developers"
#define MyAppURL "https://LATS.com"
#define MyAppExeName "lats-qt.exe"
#define MyAppExtraData "https://explorer.decenomy.net/bootstraps/LATS/bootstrap.zip"
...
[Files]
Source: ".\package\lats-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\LATS\Lats-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\LATS\Lats-Qt,strDataDir|{userappdata}\LATS\}');
  Result := True;
end;
